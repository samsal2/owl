...
owl_init_instance_(struct owl_vk_plataform const *plataform,
  ...
  instance.enabledExtensionCount = plataform->instance_extension_count;
...
owl_init_swapchain_(struct owl_vk_plataform const *plataform,
  ...
  owl_clamp_swapchain_extent_(plataform->framebuffer_width,
                              plataform->framebuffer_height, renderer);
...
enum owl_code owl_init_vk_renderer(struct owl_vk_plataform const *plataform,
  ...
  if (OWL_SUCCESS != (err = owl_init_swapchain_(plataform, renderer)))
...
enum owl_code owl_create_renderer(struct owl_window *window,
  ...
  err = owl_init_vk_renderer(&plataform, *renderer);
