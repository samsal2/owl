  ...
  for (i = 0; i < CLOTH_H; ++i) {
    for (j = 0; j < CLOTH_W; ++j) {
      ...
      if (j) {
        ...
        p->rest_distances[0] = owl_v3_distance(p->position,
                                               p->links[0]->position);
      } else {
        p->links[0] = NULL;
      ...
      if (i) {
        ...
        p->rest_distances[1] = owl_v3_distance(p->position,
                                               p->links[1]->position);
      } else {
        p->links[1] = NULL;
      ...
      if (j < CLOTH_H - 1) {
        ...
        p->rest_distances[2] = owl_v3_distance(p->position,
                                               p->links[2]->position);
      } else {
        p->links[2] = NULL;
      ...
      if (i < CLOTH_W - 1) {
        ...
        p->rest_distances[3] = owl_v3_distance(p->position,
                                               p->links[3]->position);
      } else {
        p->links[3] = NULL;
