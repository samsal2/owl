...
OWLAPI void owl_m4_translate(owl_v3 const v, owl_m4 in_out)
{
	owl_v4 v1;
	owl_v4 v2;
	owl_v4 v3;
...
OWLAPI void owl_m4_ortho(float left, float right, float bottom, float top,
			     ...
			     owl_v3 out)
{
	...
	owl_m4_make_rotate(pitch, side,
			   pitch_rotation); /* find pitch rotation */
